  ...
  <section>
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex flex-col items-center mb-6 text-2xl font-semibold text-gray-900">
        <img class="w-24 h-24 mr-2 rounded-full" src="@/assets/logoImage.jpeg" alt="logo">
        Registre-se para postar comentários em meu portifólio
      </a>
      <div
          class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-primary-800">
